...
func TestFilesInPackage(t *testing.T) {
	...
	files := module.FilesInPackage(m, "github.com/xiusin/go-annotation/internal/module")
	require.Len(t, files, 5)

	assert.Contains(t, files, "github.com/xiusin/go-annotation/internal/module/load.go")
	assert.Contains(t, files, "github.com/xiusin/go-annotation/internal/module/interface.go")
	assert.Contains(t, files, "github.com/xiusin/go-annotation/internal/module/interface_test.go")
	assert.Contains(t, files, "github.com/xiusin/go-annotation/internal/module/lookup.go")
	assert.Contains(t, files, "github.com/xiusin/go-annotation/internal/module/module.go")
}
...
func TestAbsolutePath(t *testing.T) {
	...
	s, ok := module.AbsolutePath(m, "github.com/xiusin/go-annotation/internal/module/module.go")
	require.True(t, ok)

	assert.Contains(t, s, "/src/github.com/xiusin/go-annotation/internal/module/module.go")
}
...
func TestAbsolutePath_NotFound(t *testing.T) {
	...
	s, ok := module.AbsolutePath(m, "github.com/xiusin/go-annotation/internal/module/unexpected.go")
	require.False(t, ok)
	assert.Empty(t, s)
}
