...
func (d dependencyLookup) find(m *module, importPath string) (*module, error) {
	...
	if !ok {
		log.Println("closest module was found: %s, but unable to build escaped path", mn)
		return nil, nil
	}
...
func (w workspaceLookup) find(*module, string) (*module, error) {
	log.Println("workspace module lookup is not implemented, yet")
	return nil, nil
}
...
func (v vendorLookup) find(*module, string) (*module, error) {
	log.Println("vendor module lookup is not implemented, yet")
	return nil, nil
}
