...
// For example:
// Module.Root - /home/<some-home>/go/src/github.com/xiusin/go-annotation
// Module.Files - [internal/module/lookup.go...]
// importPath - github.com/xiusin/go-annotation/internal/module
// Then the function returns all files in internal/module dir with package prefix:
//
//	"github.com/xiusin/go-annotation/internal/module/load.go"
//	"github.com/xiusin/go-annotation/internal/module/interface.go"
//	"github.com/xiusin/go-annotation/internal/module/interface_test.go"
//	"github.com/xiusin/go-annotation/internal/module/lookup.go"
//	"github.com/xiusin/go-annotation/internal/module/module.go"
func FilesInPackage(m Module, importPath string) []string {
	...
	if !ok {
		log.Println("unable to cast module %s to native module", m.Root())
		return nil
	}
...
// Module.Root - /home/<some-home>/go/src/github.com/xiusin/go-annotation
// Module.Files - [internal/module/lookup.go...]
// filePath - github.com/xiusin/go-annotation/internal/module/module.go
// return - /home/<some-home>/go/src/github.com/xiusin/go-annotation/internal/module/module.go
